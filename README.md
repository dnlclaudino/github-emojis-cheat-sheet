...
Estes emojis são automaticamente gerados a partir do [GitHub Emoji API](https://api.github.com/emojis) e [Unicode Full Emoji List](https://unicode.org/emoji/charts/full-emoji-list.html).
